...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="template/<?php echo $OJ_TEMPLATE?>/css/scrollboard.css">
...
<script type="text/javascript" src="template/<?php echo $OJ_TEMPLATE?>/js/scrollboard.js?v=0.09"></script>
