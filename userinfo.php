    ...
    <div class="jumbotron">
        ...
        <center>
            <table class="table table-striped" id=statics width=70%>
                ...
                <tr ><td width=15%><?php echo $MSG_Number?><td width=25% align=center><?php echo $Rank?>
                <td width=70% align=center>Solved Problems List</tr>
                <tr><td>判重(次数)
                <td align=center>
                    <a href="copystatus.php?user=<?=$user?>"><?=$copy_cnt?></a><td>
                    </tr>
