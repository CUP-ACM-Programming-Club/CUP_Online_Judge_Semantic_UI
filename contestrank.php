...
<div class=" padding">
    ...
    <div>
        ...
        ?>
        <center>
            <h3 class="ui top attached header">Contest RankList -- <?php echo $title ?>&nbsp;&nbsp;<button
                        class="ui primary button" onclick="location.href='contestrank.xls.php?cid=<?php echo $cid ?>'">
                    Save to XLS
                </button>
            </h3>
