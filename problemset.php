            ...
            <td>
                <div class="left aligned">
                    ...
                    <span class="ui header" v-for="_tag in row.label">
                        <a @click="tag(_tag,$event)" v-show="show_tag" :class="(typeof result.color[_tag] !== 'undefined'?result.color[_tag]:(result.color[_tag] = _.values(result.color)[Math.floor(Math.random() * _.values(result.color).length)],result.color[_tag]))+' ui label'">
                            {{_tag}}
                        </a>
                    </span>
                    </div>
