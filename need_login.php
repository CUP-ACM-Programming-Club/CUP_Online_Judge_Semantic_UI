    ...
    <div class="box loginBox">
      ...
      <form class="form">
        <div class="f_row">
          ...
          <input id="user_id" type="text" class="input-field" required>
          <u></u>
        </div>
        ...
        <div class="f_row last">
          <label>CAPTCHA</label>
          <input id="vcode" type="text" class="input-field" required style="width:70%">
          <img alt="click to change" id="vcode_graph" src="vcode.php" onclick="this.src='vcode.php?'+Math.random()" height="40px">
          <u></u>
        </div>
        ...
        <div class="f_link">
            <a href="registerpage.php" class="resetTag">New to us?Sign up.</a><br>
            <a href="lostpassword.php" class="resetTag">Forgot your password?</a>
            </div>
    ...
    function check() {
            ...
            $.post("login.php",send,function(response){
                    if (response === "true") {
                        ...
                        $("#vcode").parent().addClass("shake");
                        $("#vcode_graph").attr("src",'vcode.php?' + Math.random());
                    }
                    else {
                        $("#vcode_graph").attr("src",'vcode.php?' + Math.random());
                        $("#user_id").parent().addClass("shake");
