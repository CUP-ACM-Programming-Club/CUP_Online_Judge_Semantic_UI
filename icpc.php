...
<head>
    ...
    <title>ACM国际大学生程序设计竞赛（ACM-ICPC）.md</title>
...
<body>
<div id='write' class='is-node'><h1><a name='header-n0' class='md-header-anchor '></a><strong>ACM</strong>国际大学生程序设计竞赛（ACM-ICPC）
    </h1>
    <h2><a name='header-n15' class='md-header-anchor '></a>1.什么是ACM-ICPC？</h2>
    <div align="center"><img src='./img/icpc.jpg' alt='icpc' align=center/></div>
    <p> ACM国际大学生程序设计竞赛（ACM International Collegiate Programming
        Contest，简称ACM-ICPC或ICPC）是由国际计算机界具有悠久历史的权威性组织(美国)计算机协会（Association for Computing Machinery,
        简称ACM）主办的一项旨在展示大学生创新能力、团队精神和在压力下编写程序、分析和解决问题能力的年度竞赛。ACM国际大学生程序设计竞赛始于1970年，成形于1977年，并于1996年由上海大学引入中国大陆，目前已发展成为最具影响力的大学生计算机竞赛，被誉为“程序设计竞赛的奥林匹克”。</p>
    <p>
        参加ACM-ICPC可很好地锻炼团队成员的算法设计、逻辑推理、数学建模、程序设计和英语阅读能力。该竞赛题目使用英文描述，要求参赛者在5小时内完成10-13道题目的读题、算法设计、编码、调试并提交裁判实际运行通过，能够全面考察学生的基础理论和实际动手能力。竞赛成绩已成为通往行业内著名企业的就业通行证，参与过ACM-ICPC竞赛训练的学生因其扎实的理论功底和实践动手能力，也成为各高校研究生导师争抢的对象。</p>
    <p><strong>通过参与ACM-ICPC，大批学生得到良好的锻炼并因此到行业内著名企业高薪就业或者考取国内一流大学的研究生。</strong></p>
